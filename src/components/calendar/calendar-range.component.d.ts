...
export declare class NbCalendarRangeComponent<D> {
   ...
   * */
  set _cellComponent(
    cellComponent: Type<NbCalendarCell<D, NbCalendarRange<D>>>
  );
  dayCellComponent: Type<NbCalendarCell<D, NbCalendarRange<D>>>;
  /**
   * Custom month cell component. Have to implement `NbCalendarCell` interface.
   * */
  set _monthCellComponent(
    cellComponent: Type<NbCalendarCell<D, NbCalendarRange<D>>>
  );
  ...
  static ɵcmp: i0.ɵɵComponentDeclaration<
    ...
    never,
    {
      ...
      _monthCellComponent: "monthCellComponent";
