...
export declare class NbDialogModule {
  static forRoot(
    dialogConfig?: Partial<NbDialogConfig>
  ): ModuleWithProviders<NbDialogModule>;
  static forChild(
    dialogConfig?: Partial<NbDialogConfig>
  ): ModuleWithProviders<NbDialogModule>;
  ...
  static ɵmod: i0.ɵɵNgModuleDeclaration<
    NbDialogModule,
    [typeof i1.NbDialogContainerComponent],
    [typeof i2.NbSharedModule, typeof i3.NbOverlayModule],
    never
  >;
