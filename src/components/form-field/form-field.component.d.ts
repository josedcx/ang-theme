...
export declare class NbFormFieldComponent
  implements AfterContentChecked, AfterContentInit, AfterViewInit, OnDestroy
{
  ...
  protected getAddonClasses(
    addon: NbFormControlAddon,
    state: NbFormControlState
  ): string[];
  protected getFormControlConfig(): NbFormFieldControlConfig;
  protected isStatesEqual(
    oldState: NbFormControlState,
    state: NbFormControlState
  ): boolean;
  ...
  static ɵcmp: i0.ɵɵComponentDeclaration<
    ...
    {},
    {},
    ["formControl", "formControlConfig", "prefix", "suffix"],
    ["[nbPrefix]", "*", "[nbSuffix]"]
  >;
}
