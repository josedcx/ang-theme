...
export declare class NbLayoutComponent implements AfterViewInit, OnDestroy {
  ...
  constructor(
    ...
    document: any,
    platformId: Object,
    layoutDirectionService: NbLayoutDirectionService,
    scrollService: NbLayoutScrollService,
    rulerService: NbLayoutRulerService,
    scrollTop: NbRestoreScrollTopHelper,
    overlayContainer: NbOverlayContainerAdapter
  );
  ...
  static ɵcmp: i0.ɵɵComponentDeclaration<
    ...
    never,
    [
      "nb-layout-header:not([subheader])",
      "nb-sidebar",
...
export declare class NbLayoutHeaderComponent {
  ...
  static ɵcmp: i0.ɵɵComponentDeclaration<
    ...
    "nb-layout-header",
    never,
    { fixed: "fixed"; subheader: "subheader" },
    {},
    never,
    ["*"]
  >;
