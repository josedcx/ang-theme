 ...
 */
export declare class NbMenuComponent
  implements OnInit, AfterViewInit, OnDestroy
{
  ...
  constructor(
    window: any,
    platformId: any,
    menuInternalService: NbMenuInternalService,
    router: Router
  );
  ngOnInit(): void;
  ngAfterViewInit(): void;
  ...
  static ɵcmp: i0.ɵɵComponentDeclaration<
    ...
    "nb-menu",
    never,
    { tag: "tag"; items: "items"; autoCollapse: "autoCollapse" },
    {},
    never,
    never
  >;
