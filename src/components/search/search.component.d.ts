  ...
  implements OnChanges, AfterViewInit
{
  ...
  static ɵcmp: i0.ɵɵComponentDeclaration<
    ...
    "nb-search-field",
    never,
    { type: "type"; placeholder: "placeholder"; hint: "hint"; show: "show" },
    { close: "close"; search: "search"; searchInput: "searchInput" },
    never,
    never
  >;
}
export declare type NbSearchType =
  | "modal-zoomin"
  | "rotate-layout"
  | "modal-move"
  | "curtain"
...
export declare class NbSearchComponent implements OnInit, OnDestroy {
  ...
  constructor(
    searchService: NbSearchService,
    themeService: NbThemeService,
    router: Router,
    overlayService: NbOverlayService,
  ...
  static ɵcmp: i0.ɵɵComponentDeclaration<
    ...
    "nb-search",
    never,
    { tag: "tag"; placeholder: "placeholder"; hint: "hint"; type: "type" },
    {},
    never,
    never
  >;
