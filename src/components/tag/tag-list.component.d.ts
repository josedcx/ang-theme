 ...
 */
export declare class NbTagListComponent
  implements OnInit, AfterContentInit, AfterViewInit, OnDestroy
{
  ...
  constructor(
    ...
    renderer: Renderer2,
    zone: NgZone,
    focusMonitor: NbFocusMonitor,
    activeDescendantKeyManagerFactory: NbActiveDescendantKeyManagerFactoryService<NbTagComponent>,
  ...
  static ɵcmp: i0.ɵɵComponentDeclaration<
    ...
    "nb-tag-list",
    ["nbTagList"],
    { size: "size"; tabIndex: "tabIndex"; role: "role"; multiple: "multiple" },
    { tagRemove: "tagRemove" },
    ["tagInput", "autocompleteDirective", "tags"],
    ["nb-tag, input[nbTagInput]"]
  >;
}
