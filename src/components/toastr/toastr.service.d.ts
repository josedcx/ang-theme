...
export declare class NbToastContainer {
  ...
  constructor(
    ...
    containerRef: ComponentRef<NbToastrContainerComponent>,
  ...
  protected subscribeOnClick(
    toastComponent: NbToastComponent,
    toast: NbToast
  ): void;
...
export declare class NbToastrContainerRegistry {
  ...
  protected createContainer(
    position: NbGlobalLogicalPosition
  ): NbToastrOverlayWithContainer;
...
export declare class NbToastrService {
  ...
  constructor(
    globalConfig: NbToastrConfig,
    containerRegistry: NbToastrContainerRegistry
  );
  /**
