...
export class NbBasePicker extends NbDatepicker {
    ...
    checkFormat() {
        if (this.dateService.getId() === 'native' && this.format) {
            throw new Error("Can't format native date. To use custom formatting you have to install @ang/moment or " +
                '@ang/date-fns package and import NbMomentDateModule or NbDateFnsDateModule accordingly.' +
                'More information at "Formatting issue" ' +
                'https://akveo.github.io/ang/docs/components/datepicker/overview#nbdatepickercomponent');
        }
