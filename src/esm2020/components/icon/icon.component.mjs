 ...
 * Starting from ang 4.0 uses [Eva Icons](https://akveo.github.io/eva-icons/) pack by default.
 *
 * Basic icon example:
 ...
 * ### Installation
 *
 * By default ang comes without any pre-installed icon pack.
 * Starting with ang 4.0.0 we ship separate package called `@ang/eva-icons`
 * which integrates SVG [Eva Icons](https://akveo.github.io/eva-icons/) pack to ang. To add it to your
 * project run:
 * ```sh
 * npm i eva-icons @ang/eva-icons
 * ```
 * This command will install Eva Icons pack. Then register `NbEvaIconsModule` into your app module:
 * ```ts
 * import { NbEvaIconsModule } from '@ang/eva-icons';
 *
 * @NgModule({
 *   imports: [
 *     // ...
 ...
 * ```ts
 * import { NbIconModule } from '@ang/theme';
 *
 * @NgModule({
 *   imports: [
 *     // ...
