 ...
 * <a href="https://akveo.github.io/ang/docs/components/datepicker/overview#formatting-issue">Date picker docs</a>
    ...
    setupTimepicker() {
        if (this.dateService.getId() === 'native' && isDevMode()) {
            console.warn('Date.parse does not support parsing time with custom format.' +
                ' See details here https://akveo.github.io/ang/docs/components/datepicker/overview#native-parse-issue');
        }
