...
export const NB_WINDOW_CONTENT = new InjectionToken('ang Window Content');
export const NB_WINDOW_CONFIG = new InjectionToken('ang Window Config');
export const NB_WINDOW_CONTEXT = new InjectionToken('ang Window Context');
