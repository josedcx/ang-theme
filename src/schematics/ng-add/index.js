...
function installMainPeerDependencies(tree) {
    ...
    const angThemeVersion = (0, package_1.getAngVersion)();
    const angularCdkVersion = (0, package_1.getAngPeerDependencyVersionFromPackageJson)('@angular/cdk');
    ...
    (0, package_1.addDependencyToPackageJson)(tree, '@josedcx/ang-theme', angThemeVersion);
    (0, package_1.addDependencyToPackageJson)(tree, '@josedcx/eva-icons', angThemeVersion);
 ...
 * before running Ang setup in the project.
 *
