...
function registerAngModules(options) {
    return (tree) => __awaiter(this, void 0, void 0, function* () {
        const project = yield (0, util_1.getProject)(tree, options.project);
        const angThemeModule = `NbThemeModule.forRoot({ name: '${options.theme}' })`;
        (0, schematics_2.addModuleImportToRootModule)(tree, angThemeModule, '@josedcx/ang-theme', project);
        (0, schematics_2.addModuleImportToRootModule)(tree, 'NbLayoutModule', '@josedcx/ang-theme', project);
        (0, schematics_2.addModuleImportToRootModule)(tree, 'NbEvaIconsModule', '@josedcx/eva-icons', project);
    });
}
/**
