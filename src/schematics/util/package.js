...
exports.addDevDependencyToPackageJson = exports.getDevDependencyVersionFromPackageJson = exports.addDependencyToPackageJson = exports.getDependencyVersionFromPackageJson = exports.getEvaIconsVersion = exports.getAngPeerDependencyVersionFromPackageJson = exports.getAngVersion = void 0;
const file_1 = require("./file");
const packageJsonName = 'package.json';
function getAngVersion() {
    return getAngPackageJson().version;
}
exports.getAngVersion = getAngVersion;
/**
 * Gets the version of the specified Ang peerDependency
 * */
function getAngPeerDependencyVersionFromPackageJson(packageName) {
    const packageJson = getAngPackageJson();
...
exports.getAngPeerDependencyVersionFromPackageJson = getAngPeerDependencyVersionFromPackageJson;
/**
 * Eva Icons version
 * */
function getEvaIconsVersion() {
    const packageJson = getAngEvaIconsPackageJson();
...
function getAngPackageJson() {
    return require('../../package.json');
}
function getAngEvaIconsPackageJson() {
